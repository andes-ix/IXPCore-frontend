const Componente1 = () => {
  return (
    <div className="absolute top-[144px] left-[23px] w-[227.3px] h-[322.7px] text-left text-base text-lightslategray-100 font-open-sans">
      <div className="absolute top-[calc(50%_-_106.65px)] left-[calc(50%_-_60.65px)]">
        Dashboard
      </div>
      <div className="absolute top-[calc(50%_-_35.65px)] left-[calc(50%_-_60.65px)]">
        Cuenta
      </div>
      <div className="absolute top-[calc(50%_+_35.35px)] left-[calc(50%_-_60.65px)]">
        Usuarios
      </div>
      <div className="absolute bottom-[0px] left-[calc(50%_-_60.65px)] text-sm text-white opacity-[0]">
        Listado de usuarios
      </div>
      <div className="absolute top-[calc(50%_+_24.35px)] left-[calc(50%_-_60.65px)] text-sm text-white opacity-[0]">
        Listado de usuarios
      </div>
      ...
      <img
        className="absolute top-[calc(50%_+_41.65px)] right-[0px] w-[7.3px] h-3"
        alt=""
        src="/chevronright2.svg"
      />
      <img
        className="absolute top-[calc(50%_-_29.35px)] right-[0px] w-[7.3px] h-3"
        alt=""
        src="/chevronright2.svg"
      />
      ...
      <img
        className="absolute top-[calc(50%_-_32.35px)] left-[13px] w-[21px] h-5"
        alt=""
        src="/wallet.svg"
      />
      <div className="absolute top-[calc(50%_+_34.65px)] left-[11px] rounded-sm box-border w-5 h-5 border-[2px] border-solid border-lightslategray-100">
        <img
