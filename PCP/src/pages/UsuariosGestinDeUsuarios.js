...
const UsuariosGestinDeUsuarios = () => {
  ...
  return (
    <>
      <div className="relative bg-aliceblue-200 w-full h-[1313px] text-left text-base text-dimgray-200 font-open-sans">
        <div className="absolute top-[130px] left-[332px] text-9xl">
          Usuarios
        </div>
        <div className="absolute top-[140px] right-[117px] w-[209px] h-[19px] text-sm text-cornflowerblue">
          <div className="absolute top-[0px] left-[0px]">Usarios</div>
          <div className="absolute top-[0px] right-[-1px]">
            Listado de usuarios
          </div>
          <img
            className="absolute bottom-[2px] left-[calc(50%_-_38.5px)] w-[7.3px] h-3"
            alt=""
        ...
        />
        <div className="absolute top-[144px] left-[17.17px] w-[261.9px] h-[277.7px] text-lightslategray-100">
          <img
            className="absolute w-full top-[182px] right-[0px] left-[0px] max-w-full overflow-hidden h-[49.7px]"
            alt=""
            src="/rectangle.svg"
          />
          <div className="absolute top-[calc(50%_-_84.15px)] left-[calc(50%_-_72.12px)]">
            Dashboard
          </div>
          <div className="absolute top-[calc(50%_-_13.15px)] left-[calc(50%_-_72.12px)]">
            Cuenta
          </div>
          <div className="absolute top-[calc(50%_+_57.85px)] left-[calc(50%_-_72.12px)] text-steelblue">
            Usuarios
          </div>
          <div className="absolute bottom-[0px] left-[calc(50%_-_72.12px)] text-sm text-cornflowerblue">
            Listado de usuarios
          </div>
          <div className="absolute top-[calc(50%_+_46.85px)] left-[calc(50%_-_72.12px)] text-sm text-white opacity-[0]">
            Listado de usuarios
          </div>
          ...
          <img
            className="absolute top-[calc(50%_+_66.51px)] right-[26.43px] w-3 h-[7.3px]"
            alt=""
            src="/chevronright1.svg"
          />
          <img
            className="absolute top-[calc(50%_-_6.85px)] right-[28.77px] w-[7.3px] h-3"
            alt=""
            src="/chevronright2.svg"
          />
          <div
            className="absolute top-[calc(50%_-_81.85px)] left-[18.83px] w-[18px] h-[18px] cursor-pointer"
          ...
          <img
            className="absolute top-[calc(50%_-_9.85px)] left-[18.83px] w-[21px] h-5"
            alt=""
            src="/wallet.svg"
          />
          <div className="absolute top-[calc(50%_+_57.15px)] left-[16.83px] rounded-sm box-border w-5 h-5 border-[2px] border-solid border-steelblue">
            <img
          ...
          />
          <img
            className="absolute top-[calc(50%_+_56.15px)] left-[24.83px] w-1 h-1 opacity-[0]"
            alt=""
            src="/oval1.svg"
          />
        </div>
        ...
        <div className="absolute top-[193.83px] right-[109px] w-[1479px] h-[1077.2px] text-darkslategray">
          ...
          <div className="absolute top-[119.17px] left-[33px] shadow-[0px_3px_6px_rgba(0,_0,_0,_0.02)] rounded-md bg-white box-border w-[380px] h-12 border-[1px] border-solid border-whitesmoke-400" />
          ...
          <b className="absolute top-[calc(50%_-_321.43px)] right-[130.46px] leading-[13px] text-lightslategray-100">
            Operación
          </b>
          ...
          <b className="absolute top-[calc(50%_-_185.43px)] left-[calc(50%_-_500.25px)] text-sm text-royalblue">
            Juan Hernandez
          </b>
          ...
          <div className="absolute bottom-[145.03px] left-[calc(50%_-_37.44px)]">
            Example@gmaillc.om
          </div>
          <div className="absolute bottom-[145.03px] left-[calc(50%_+_184.56px)]">
            Atención al cliente
          </div>
          <div className="absolute bottom-[145.03px] left-[calc(50%_+_401.56px)]">
            Finanzas
          </div>
          ...
          <div className="absolute bottom-[141.03px] left-[calc(50%_-_260.84px)]">
            +56 5875 25475
          </div>
