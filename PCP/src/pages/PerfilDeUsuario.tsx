...
const PerfilDeUsuario: FunctionComponent = () => {
  ...
  return (
    <div className={styles.perfilDeUsuario5}>
      ...
      <div className={styles.usaLosCdigosContainer}>
        <p className={styles.usaLosCdigos}>
          Usa los códigos generados por tu aplicación de autenticación para
          iniciar
        </p>
        <p className={styles.usaLosCdigos}>
          sesión cada vez que ingreses en un dispositivo no asociado a tu cuenta
          de
        </p>
        <p className={styles.usaLosCdigos}>usuario.</p>
      </div>
      <div className={styles.grupo9}>
        <div className={styles.desactivar}>Desactivar</div>
      </div>
      <div className={styles.lnea54} />
      <div className={styles.rectngulo6320} />
      <div className={styles.activado}>Activado</div>
      <img className={styles.rectangle2Icon} alt="" src="/rectangle2.svg" />
      <div className={styles.perfilDeUsuario5Child} />
      <img
        className={styles.logoPlaceholder3RemovebgPrIcon}
        alt=""
        src="/logoplaceholder3removebgpreview@2x.png"
      />
      <div className={styles.componente198}>
      ...
      <div className={styles.grupo37694}>
        ...
        <img
          className={styles.componente2222}
          alt=""
          src="/componente-22--22.svg"
        />
        <img
          className={styles.componente2223}
          alt=""
        ...
        />
        <div className={styles.componente238}>
          <img
        ...
        <div className={styles.componente2224}>
