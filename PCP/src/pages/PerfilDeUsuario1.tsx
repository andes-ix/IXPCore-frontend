...
const PerfilDeUsuario1: FunctionComponent = () => {
  ...
  return (
    <div className={styles.perfilDeUsuario6}>
      ...
      <div className={styles.introduceElCdigoContainer}>
        <p className={styles.introduceElCdigo}>
          Introduce el código de verificación de 6 dígitos generado por la
        </p>
        <p className={styles.introduceElCdigo}>aplicación de autenticación.</p>
      </div>
      ...
      <div className={styles.grupo37694}>
        ...
        <img
          className={styles.componente2219}
          alt=""
          src="/componente-22--22.svg"
        />
        <img
          className={styles.componente2220}
          alt=""
        ...
        />
        <div className={styles.componente237}>
          <img
        ...
        <div className={styles.componente2221}>
