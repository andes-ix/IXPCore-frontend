...
const PerfilDeUsuario2: FunctionComponent = () => {
  ...
  return (
    <div className={styles.perfilDeUsuario7}>
      ...
      <div className={styles.configuraUnaAplicacin}>
        Configura una aplicación de autenticación
      </div>
      <div className={styles.instalaLaAplicacin}>
        1. Instala la aplicación de Google authenticator en tu dispositivo
        móvil.
      </div>
      <div className={styles.agregaTuCuentaContainer}>
        <p
          className={styles.agregaTuCuenta}
        >{`2. Agrega tu cuenta a la aplicación de autenticación a través de la `}</p>
        <p className={styles.agregaTuCuenta}>
          opción para añadir una cuenta nueva.
        </p>
      </div>
      <div className={styles.usaPortalDe}>
        3. Usa Portal de Pago PIT como nombre de la cuenta y escribe esta clave
        secreta.
      </div>
      <div className={styles.grupo9} onClick={onGrupo9ContainerClick}>
        <div className={styles.continuar}>Continuar</div>
      </div>
      <div className={styles.rectngulo6319} />
      <div className={styles.bxucqwjnb5lu2ef3}>BXUCQWJNB5LU2EF3</div>
      <img
        className={styles.icFilterNone24pxIcon}
        alt=""
        src="/ic-filter-none-24px.svg"
      />
      <b className={styles.activities}>Escanea el codigo QR</b>
      <div className={styles.activities1}>
        ó use el código secreto para crear su registro en la aplicación de
        Google Authenticator
      </div>
      <img
        className={styles.codigoQr1024x10241Icon}
        alt=""
        src="/codigoqr1024x10241@2x.png"
      />
      <img className={styles.rectangle2Icon} alt="" src="/rectangle2.svg" />
      <div className={styles.perfilDeUsuario7Child} />
      <img
        className={styles.logoPlaceholder3RemovebgPrIcon}
        alt=""
        src="/logoplaceholder3removebgpreview@2x.png"
      />
      <div className={styles.componente196}>
      ...
      <div className={styles.grupo37694}>
        ...
        <img
          className={styles.componente2216}
          alt=""
          src="/componente-22--22.svg"
        />
        <img
          className={styles.componente2217}
          alt=""
        ...
        />
        <div className={styles.componente236}>
          <img
        ...
        <div className={styles.componente2218}>
      ...
      <div className={styles.asegreseDeQueContainer}>
        ...
        <p className={styles.agregaTuCuenta}>facturación de sus servicios</p>
      </div>
