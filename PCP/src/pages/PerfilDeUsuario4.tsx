...
import styles from "./PerfilDeUsuario4.module.css";

const PerfilDeUsuario4: FunctionComponent = () => {
  const navigate = useNavigate();

  const onConfigurarTextClick = useCallback(() => {
    navigate("/perfil-de-usuario-8");
  }, [navigate]);

  return (
    <div className={styles.perfilDeUsuario9}>
      <div className={styles.informacinDePerfil}>Información de perfil</div>
      ...
      <div className={styles.tuAplicacinDeContainer}>
        <p className={styles.asegreseDeQue}>
          Tu aplicación de autenticación nos permite añadir un nivel de
          verificación
        </p>
        <p className={styles.asegreseDeQue}>extra para proteger tu cuenta.</p>
      </div>
      ...
      <div className={styles.grupo9}>
        <div className={styles.configurar} onClick={onConfigurarTextClick}>
          Configurar
        </div>
      </div>
      ...
      <div className={styles.grupo37694}>
        ...
        <img
          className={styles.componente2210}
          alt=""
          src="/componente-22--22.svg"
        />
        <img
          className={styles.componente2211}
          alt=""
        ...
        />
        <div className={styles.componente234}>
          <img
          ...
          <div className={styles.grupo37693}>
            ...
            <div className={styles.informacinDePerfil1}>
        ...
        <div className={styles.componente2212}>
...
export default PerfilDeUsuario4;
