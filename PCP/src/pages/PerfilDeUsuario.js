...
const PerfilDeUsuario = () => {
  return (
    <div className="relative bg-aliceblue-200 w-full h-[1151px] text-left text-sm text-gray-200 font-open-sans">
      ...
      <div className="absolute top-[206px] left-[1212px] text-xl font-semibold text-dimgray-200">
      ...
      <div className="absolute top-[283px] right-[171px] leading-[22px] text-dimgray-100">
        <p className="m-0">
      ...
      <div className="absolute top-[370px] right-[195px] leading-[22px] text-dimgray-100">
        <p className="m-0">
      ...
      <div className="absolute bottom-[42px] left-[332px] rounded-t-none rounded-b bg-whitesmoke-300 w-[712px] h-[588px]" />
      ...
      <div className="absolute bottom-[81px] left-[846px] shadow-[0px_3px_6px_rgba(0,_0,_0,_0.02)] rounded-md bg-cornflowerblue w-[136px] h-12 text-base text-white">
      ...
      <div className="absolute bottom-[178px] left-[372px] shadow-[0px_3px_6px_rgba(0,_0,_0,_0.02)] rounded-md bg-white w-[290px] h-12" />
      <div className="absolute bottom-[192px] left-[386px] text-lightslategray-200">
        ******
      </div>
      <div className="absolute top-[897px] left-[607px] text-xs font-semibold text-cornflowerblue">
        ¿Olvidó?
      </div>
      <div className="absolute top-[896px] left-[372px] font-semibold">
        Contraseña actual
      </div>
      <div className="absolute bottom-[178px] left-[688px] shadow-[0px_3px_6px_rgba(0,_0,_0,_0.02)] rounded-md bg-white w-[294px] h-12" />
      <div className="absolute bottom-[192px] left-[702px] text-lightslategray-200 opacity-[0.4]">
        Nueva contraseña
      </div>
      <div className="absolute top-[896px] left-[688px] font-semibold">
        Nueva contraseña
      </div>
      ...
      <img
        className="absolute top-[865.5px] left-[331.5px] w-[712px] h-[3px]"
        alt=""
        src="/lnea-49.svg"
      />
      <img
      ...
      <Componente1 />
      <Grupo />
      <div className="absolute top-[289px] left-[1224px] text-xl font-semibold text-white">
        1
      </div>
      <div className="absolute top-[376px] left-[1224px] text-xl font-semibold text-white">
        2
      </div>
      <img
