...
import GrupoDeDesplazamiento1 from "../components/grupo-de-desplazamiento1";

const DetalleFactura: FunctionComponent = () => {
  return (
    <div className="relative bg-gray-300 w-full h-[1411px] text-left text-sm text-dimgray-100 font-open-sans">
