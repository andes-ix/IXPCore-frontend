...
const Login1: FunctionComponent = () => {
  ...
  return (
    <div className="relative bg-whitesmoke-300 w-full h-[930px] text-left text-sm text-dimgray-200 font-open-sans">
      ...
      <div className="absolute bottom-[138px] left-[0px] w-[416px] h-[645px]">
        ...
        <div className="absolute w-[calc(100%_-_102px)] top-[calc(50%_-_147.5px)] left-[39px] text-xs leading-[22px] text-lightslategray-100 inline-block h-16">
        ...
        <div className="absolute top-[calc(50%_-_74.5px)] left-[53px] text-cornflowerblue">
        ...
        />
        <Grupo5 />
        <div className="absolute w-[calc(100%_-_61px)] right-[22px] bottom-[42px] left-[39px] h-12 text-white">
          <img
