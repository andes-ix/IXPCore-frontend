...
import {
  getInvoiceDataTableStruct as onGetDataTableStruct,
  getInvoiceDataTableView as onGeDataTableView,
} from "slices/thunk";
...
const InvoiceTableComponent: React.FC<InvoiceTableComponentProps> = (
  ...
  const selectDataList = createSelector(
    ...
    (data) => ({
      dataTableView: data.invoiceDataView,
      dataTableStruct: data.invoiceDataStruct,
    })
  );
