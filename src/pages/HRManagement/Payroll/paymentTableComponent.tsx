...
import {
  getPaymentDataTableStruct as onGetDataTableStruct,
  getPaymentDataTableView as onGeDataTableView,
} from "slices/thunk";
...
const PaymentTableComponent: React.FC<PaymentTableComponentProps> = (
  ...
  const selectDataList = createSelector(
    ...
    (data) => ({
      dataTableView: data.paymentDataView,
      dataTableStruct: data.paymentDataStruct,
    })
  );
