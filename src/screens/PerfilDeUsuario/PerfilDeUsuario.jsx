    ...
    <div className="perfil-de-usuario">
      <div className="div">
        <div className="overlap">
          <div className="overlap-group">
            <div className="overlap-2">
              <div className="text-wrapper">Información de perfil</div>
              <div className="text-wrapper-2">Seguridad</div>
              <p className="p">Revise y actualice los detalles de su cuenta</p>
              <div className="text-wrapper-3">Verificación en dos pasos</div>
              ...
              <p className="text-wrapper-4">Protege tu cuenta con la verificación en dos pasos</p>
              <p className="la-verificaci-n-en">
              ...
              <img className="lock-star-line" alt="Lock star line" src="/img/lock-star-line.png" />
            </div>
        ...
        <p className="tu-aplicaci-n-de">
          ...
          <br />
          extra para proteger tu cuenta.
        </p>
        <div className="overlap-4">
          <div className="rectngulo-5" />
          <div className="text-wrapper-8">Salvador Bertenbreiter</div>
          <div className="rectngulo-6" />
          <div className="text-wrapper-9">Nombre completo</div>
          <div className="text-wrapper-10">Cargo</div>
          <div className="rectngulo-7" />
          <div className="rectngulo-8" />
          <div className="grupo-4">
            <div className="text-wrapper-11">Actualizar</div>
          </div>
          <div className="rectngulo-9" />
          <div className="text-wrapper-12">Salvador Bertenbreiter</div>
          <div className="text-wrapper-13">Gerente general</div>
          <div className="text-wrapper-14">Peru</div>
          <div className="text-wrapper-15">Pais</div>
          <div className="rectngulo-10" />
          <div className="text-wrapper-16">Example@pit.net</div>
          <div className="text-wrapper-17">Correo electronico</div>
          ...
          <p className="text-wrapper-20">Autogestión de contraseña: Cambio de contraseña</p>
          <p className="text-wrapper-21">Realiza el cambio de tu contraseña de acceso, de manera fácil y rápida.</p>
        </div>
        <div className="grupo-6">
          <div className="text-wrapper-11">Configurar</div>
        </div>
