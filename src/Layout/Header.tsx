            ...
            <div className="flex items-center w-full group-data-[layout=horizontal]:mx-auto group-data-[layout=horizontal]:max-w-screen-2xl navbar-header group-data-[layout=horizontal]:ltr:xl:pr-3 group-data-[layout=horizontal]:rtl:xl:pl-3">
              ...
              <div className="flex gap-3 ms-auto">
                <div className="flex flex-wrap items-center gap-3">
                  <span className="px-3 py-1 text-xs font-medium inline-block rounded border bg-custom-500 border-custom-500 text-custom-50">
                    Administrador ISP
                  </span>
                </div>
                ...
                <Dropdown className="relative flex items-center h-header pr-5">
                  <Dropdown.Trigger
                    type="button"
                  ...
                  >
                    ...
                    <ul>
                      <li>
                        <a
                          className="flex block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500"
