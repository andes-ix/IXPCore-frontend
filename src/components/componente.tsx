...
const Componente: FunctionComponent<ComponenteType> = memo(
  ({ className = "", onInformacinDePerfilClick }) => {
    ...
    return (
      <div
        className={`absolute h-[calc(100%_-_24px)] top-[24px] right-[101px] bottom-[0px] w-[302px] text-left text-sm text-dimgray-200 font-open-sans ${className}`}
      >
        <img
