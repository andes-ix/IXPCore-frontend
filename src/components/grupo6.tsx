...
export type Grupo6Type = {
  className?: string;
};

const Grupo6: FunctionComponent<Grupo6Type> = memo(({ className = "" }) => {
  ...
  return (
    <div
      className={`absolute top-[153px] left-[0px] w-[416px] h-[567px] text-left text-sm text-cornflowerblue font-open-sans ${className}`}
    >
      ...
      <div className="absolute w-[calc(100%_-_61px)] top-[calc(50%_-_8.5px)] right-[22px] left-[39px] h-[115px] text-dimgray-100">
        ...
        <div className="absolute top-[calc(50%_+_37.5px)] left-[calc(50%_-_177.5px)] [filter:drop-shadow(-1.8461538553237915px_4.307692527770996px_8px_#f1f7ff)] rounded-8xs box-border w-5 h-5 border-[1px] border-solid border-gray-400" />
      </div>
