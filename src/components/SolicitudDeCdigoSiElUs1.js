...
const SolicitudDeCdigoSiElUs1 = ({ className = "" }) => {
  return (
    <div
      className={`relative bg-gray-500 w-[1920px] h-[1074px] max-w-full max-h-full overflow-auto text-left text-sm text-dimgray-100 font-open-sans ${className}`}
    >
      <div className="absolute top-[212px] left-[617px] shadow-[0px_3px_6px_rgba(0,_0,_0,_0.1)] rounded bg-white w-[687px] h-[651px]">
...
SolicitudDeCdigoSiElUs1.propTypes = {
