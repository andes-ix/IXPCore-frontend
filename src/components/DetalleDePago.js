...
const DetalleDePago = ({ className = "" }) => {
  return (
    <div
      className={`relative bg-gray-400 w-[430px] h-[929px] max-w-full max-h-full overflow-auto text-left text-sm text-lightslategray-100 font-open-sans ${className}`}
    >
